...
Activity("Cerimônia de Abertura", datetime(2023, 6, 13, 19, 0), datetime(2023, 6, 13, 20, 0), [autores["Aplam"]], autores["Aplam"], id_pousada, 0, 100, id_evento).save()
...
Activity("Musicalização", datetime(2023, 6, 14, 10, 0), datetime(2023, 6, 14, 10, 30), [autores["Priscila Sabino e Amanda Luz"]], autores["Priscila Sabino e Amanda Luz"], id_bebeteca, 0, 5, id_evento).save()
...
Activity("Oficinas: Escolas Estaduais", datetime(2023, 6, 14, 15, 0), datetime(2023, 6, 14, 16, 0), [autores["Liduina, Iris, Mauricio e Clara"]], autores["Liduina, Iris, Mauricio e Clara"], id_tenda, 0, 100, id_evento).save()
Activity("Espetáculo - Palco Bebeteca", datetime(2023, 6, 14, 15, 0), datetime(2023, 6, 14, 16, 0), [autores["Turma do Caracol"]], autores["Turma do Caracol"], id_palco, 0, 12, id_teatro).save()
...
Activity("Musicalização para bebês - Bebeteca", datetime(2023, 6, 14, 15, 0), datetime(2023, 6, 14, 16, 20), [autores["Priscila Sabino e Amanda Luz"]], autores["Priscila Sabino e Amanda Luz"], id_bebeteca, 0, 5, id_teatro).save()
...
Activity("Show - Bebeteca", datetime(2023, 6, 15, 16, 30), datetime(2023, 6, 15, 17, 30), [autores["Turma do Caracol ( Maria e André Cerino)"]], autores["Turma do Caracol ( Maria e André Cerino)"], id_palco, 0, 5, id_evento).save()
Activity("Mesa de debates: o livro das Nossas Vidas", datetime(2023, 6, 15, 16, 0), datetime(2023, 6, 15, 18, 0), [autores["Cinco escritoras mulheres da Flipiri"], autores["Mediadora: Lariza Amélia Eloi"]], autores["Mediadora: Lariza Amélia Eloi"], id_teatro2, 0, 100, id_debate).save()
...
Activity("Cerimônia de Encerramento", datetime(2023, 6, 15, 20, 30), datetime(2023, 6, 15, 22, 30), [autores["Diretoria da Casa de Autores e colaboradores / Marcelo Barra"]], autores["Diretoria da Casa de Autores e colaboradores / Marcelo Barra"], id_praca, 0, 100, id_evento).save()
